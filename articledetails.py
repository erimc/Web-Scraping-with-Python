...
class ArticleDetails(scrapy.Spider):
    ...
    def parse(self, response):
            ...
            author_firstname = driver.find_elements_by_xpath('//*[@class="author size-m workspace-trigger"]//*[@class="text given-name"]')
            author_lastname = driver.find_elements_by_xpath('//*[@class="author size-m workspace-trigger"]//*[@class="text surname"]')
            ...
            abstract = "None"
            try:
                abstract = driver.find_element_by_xpath("//div[@class='abstract author']//p").text
            except:
                pass
